...
wave_data_nopp2 = wave_data_nopp2[w_nopp2_indices, :].copy()
...
wave_data_mulit1 = wave_data_mulit1[w_wave_data_multi1,:].copy()
...
wave_data_nbdc = wave_data_nbdc[w_wave_data_nbdc,:].copy()
